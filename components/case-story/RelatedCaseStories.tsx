...
import { CaseStoriesData } from "types/content";

interface RelatedCaseStoriesProps {
  relatedCaseStories: CaseStoriesData;
}

const RelatedCaseStories = ({
  relatedCaseStories,
}: RelatedCaseStoriesProps) => {
  return (
...
export default RelatedCaseStories;
