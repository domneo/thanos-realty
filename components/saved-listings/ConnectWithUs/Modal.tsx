...
export const Modal = ({ showModal, setShowModal }: ModalProps) => {
  ...
  return (
    <ReactModal
      ...
      overlayClassName={"savedlistings-connectwithus-modal-overlay"}
      className="savedlistings-connectwithus-modal-content"
    ...
    >
      <style jsx global>
        {`
          .savedlistings-connectwithus-modal-overlay {
            position: fixed;
            inset: 0;
            overflow: auto;
            padding: 3rem 1rem;
          ...
          .savedlistings-connectwithus-modal-content {
            max-width: 1120px;
            margin: 0 auto;
            ...
            {!showSuccess && !showError && (
              <>
                ...
                <h5 className="sans-serif text-center text-black">
                  {removeWidows(
                    "Let us match the right space to fit your business."
                  )}
                </h5>
                <Form
